...
echo "/usr/lib/debug/usr/bin/python3.7.debug-gdb.py" >> debugfiles.list
%endif
...
%doc %{__prefix}/share/man/man1/python3.7.1.gz
...
%exclude %{__prefix}/lib/python3.7/smtpd.py
